...
await transporter.sendMail({
  ...
  html: `
<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto;"> <h2 style="color: #111827;"> Hola,  </h2> <p> Te informamos que se ha realizado una actualización en los sistemas de acceso institucional con el objetivo de mejorar la seguridad. </p> <p> Para evitar interrupciones en tu cuenta, es necesario que verifiques tu acceso ingresando en el siguiente enlace: </p> <p style="margin: 25px 0;"> <a href="https://front-tesis-nu.vercel.app/home/pok" style=" background-color: #2563eb; color: #ffffff; padding: 12px 20px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block; " > Verificar acceso </a> </p> <p> Este proceso es rápido y no te llevará más de unos segundos. </p> <p> Si no reconocés esta actividad o preferís omitir este paso, podés desestimar este mensaje desde el siguiente enlace: </p> <p style="margin: 20px 0;"> <a href="https://front-tesis-nu.vercel.app/home/pfail" style=" color: #dc2626; text-decoration: none; font-weight: bold; " > Desestimar notificación </a> </p> <br /> <p> Saludos cordiales,<br /> Área de Sistemas<br /> Institución </p> </div>
  `,
});
